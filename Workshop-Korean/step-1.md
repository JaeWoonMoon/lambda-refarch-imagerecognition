...
1. 방금 만든 상태 머신을 선택하십시오.**상태 시스템 편집**을 클릭하십시오.

	<img src="images/1d-edit.png" width="90%">

1. 속성 "ResultPath": "$ .extractedMetadata"를 태스크에 추가하십시오. 마지막 JSON은 다음과 같아야합니다.
...
1. 또한 나중에 추가 작업을 위해 텍스트 편집기에 새 정의를 복사 / 붙여 넣기하십시오.

1. **업데이트를 클릭하고 실행을 시작하십시오.**

1. 1C-2 단계에서 사용한 것과 동일한 JSON 입력을 입력하십시오 ( 'ImageProcessing`의 실행 기록으로 이동하여 세부 정보> 입력 평면에서 JSON을 복사하여 찾을 수 있습니다).**실행 시작**을 클릭하십시오.
